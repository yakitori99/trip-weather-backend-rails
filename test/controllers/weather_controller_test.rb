...
class WeatherControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should get_weather_from_by_citycode" do
    city_codes = ['130010', '390010']

    for city_code in city_codes
      get '/weather_from/' + city_code
      ...
      for i in 0..1
        # 日付と日付の型、ソート順が正しいことを確認
        assert_equal((time_now + (i-1).days).strftime("%Y/%m/%d"), res[i]["DateTimeStr"][0..9])
